  ...
  Alpine.store("cart", {
    ...
    add(newItem) {
      ...
      if (!cartItem) {
        ...
        //jika barangnya udah ada, cek apakah barang yang ada sama dengan barang yang ada di cart
        this.items = this.items.map((item) => {
          // jika barang berbeda
          if (item.id !== newItem.id) {
            return item;
          } else {
            // jika barang sudah ada, tambah jumlah dan quantity dan totalnya
            item.quantity++;
...
// kirim data ketika tombol checkout di clik
